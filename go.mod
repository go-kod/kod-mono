...
require (
	...
	github.com/go-kod/kod v0.7.0
	github.com/go-kod/kod/ext v0.7.0
...
require (
	...
	github.com/uptrace/uptrace-go v1.26.0 // indirect
	...
	go.opentelemetry.io/contrib/samplers/probability/consistent v0.20.0 // indirect
