...
//
//	mockgen -source internal/infra/redis/kod_gen_interface.go -destination internal/infra/redis/kod_gen_mock.go -package redis -typed -build_constraint !ignoreKodGen
//
