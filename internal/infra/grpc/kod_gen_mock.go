...
//
//	mockgen -source internal/infra/grpc/kod_gen_interface.go -destination internal/infra/grpc/kod_gen_mock.go -package grpc -typed -build_constraint !ignoreKodGen
//
