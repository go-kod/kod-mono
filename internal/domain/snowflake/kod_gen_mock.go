...
//
//	mockgen -source internal/domain/snowflake/kod_gen_interface.go -destination internal/domain/snowflake/kod_gen_mock.go -package snowflake -typed -build_constraint !ignoreKodGen
//
